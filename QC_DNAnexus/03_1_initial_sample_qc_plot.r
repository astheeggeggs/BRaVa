install.packages(c('data.table', 'ggplot2', 'dplyr', 'ggsci', 'ggrastr', 'ggrepel', 'latex2exp'))
...
# Inputs:
INITIAL_SAMPLE_QC_FILE <- paste0('/mnt/project//Barney/qc2/03_initial_sample/03_initial_sample_qc_chr', CHR, '.tsv')

# Outputs:
INITIAL_COMBINED_SAMPLE_QC_FILE <- '03_initial_sample_qc.tsv'
