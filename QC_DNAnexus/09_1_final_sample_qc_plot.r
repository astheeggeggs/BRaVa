...
# Input files
SAMPLE_BEFORE_QC_FILE <-  '/mnt/project/Barney/qc2/09_0_final_sample_qc/09_final_qc_chr@.before.'
SAMPLE_AFTER_QC_FILE <-  '/mnt/project/Barney/qc2/09_0_final_sample_qc/09_final_qc_chr@.after.'

# Output files
SAMPLE_BEFORE_AFTER_COMBINED_QC_FILE <- '09_final_qc.before.after.combined.samples.tsv'
...
for (pop in c("AFR", "AMR", "EAS", "EUR", "SAS"))
{
    ...
    print(paste0(gsub("@", CHR, SAMPLE_BEFORE_QC_FILE), pop, ".samples.tsv.bgz"))
